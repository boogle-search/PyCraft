...
class MyGame(ShowBase):
    ...
    def setupControls(self):
        ...
        self.accept('1', self.setSelectdBlockType, ['grass'])
        self.accept('2', self.setSelectdBlockType, ['dirt'])
        self.accept('3', self.setSelectdBlockType, ['sand'])
        self.accept('4', self.setSelectdBlockType, ['stone'])

    def setSelectdBlockType(self, type):
